      ...
      <Col xs={8} sm={8} md={6} lg={6}>
        ...
        <Form onSubmit={submitRegisterForm}>
          <Form.Group>
            ...
            <Form.Control type="email" value={variables.email} onChange={e => setVariables({ ...variables, email: e.target.value })} className={errors.email && 'is-invalid'} />
          </Form.Group>
          ...
          <Form.Group>
            ...
            <Form.Control type="password" value={variables.confirmPassword} onChange={e => setVariables({ ...variables, confirmPassword: e.target.value })} className={errors.confirmPassword && 'is-invalid'} />
          </Form.Group>
